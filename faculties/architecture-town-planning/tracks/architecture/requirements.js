/* FinDeg – standby: מסלול "ארכיטקטורה", הפקולטה לארכיטקטורה ובינוי ערים.
 ...
 * נרשם לתוך window.FINDEG_TRACK_DEFS['architecture-town-planning']['architecture'] - נאסף
...
window.FINDEG_TRACK_DEFS['architecture-town-planning']['architecture'] = {
  name: "ארכיטקטורה",
