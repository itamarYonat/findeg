/* FinDeg – הפקולטה לכימיה: standby, שלד בלבד - אין עדיין דרישות תואר אמיתיות.
 * מרכיב את tracks של הפקולטה הזו מתוך window.FINDEG_TRACK_DEFS['chemistry'] - נבנה ע"י כל
 * אחד מקבצי faculties/chemistry/tracks/<track>/requirements.js (נטענים לפני קובץ זה,
...
window.FINDEG_DATA = (function () {
  const tracks = (window.FINDEG_TRACK_DEFS && window.FINDEG_TRACK_DEFS['chemistry']) || {};
  return {
    courseNames: {},
    coursePoints: {},
    equivGroups: [],
