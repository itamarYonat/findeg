/* FinDeg – standby: מסלול "כימיה (ביוכימיה מולקולרית)", הפקולטה לכימיה.
 ...
 * נרשם לתוך window.FINDEG_TRACK_DEFS['chemistry']['chemistry'] - נאסף
...
window.FINDEG_TRACK_DEFS['chemistry']['chemistry'] = {
  name: "כימיה (ביוכימיה מולקולרית)",
