/* FinDeg – standby: מסלול "הנדסת חשמל", הפקולטה להנדסת חשמל ומחשבים.
 ...
 * נרשם לתוך window.FINDEG_TRACK_DEFS['electrical-computer']['electrical'] - נאסף
...
window.FINDEG_TRACK_DEFS['electrical-computer']['electrical'] = {
  name: "הנדסת חשמל",
