/* FinDeg – הפקולטה להנדסת מכונות: standby, שלד בלבד - אין עדיין דרישות תואר אמיתיות.
 * מרכיב את tracks של הפקולטה הזו מתוך window.FINDEG_TRACK_DEFS['mechanical'] - נבנה ע"י כל
 * אחד מקבצי faculties/mechanical/tracks/<track>/requirements.js (נטענים לפני קובץ זה,
...
window.FINDEG_DATA = (function () {
  const tracks = (window.FINDEG_TRACK_DEFS && window.FINDEG_TRACK_DEFS['mechanical']) || {};
  return {
    courseNames: {},
    coursePoints: {},
    equivGroups: [],
