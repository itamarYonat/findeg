/* FinDeg – הפקולטה להנדסה ביו-רפואית: standby, שלד בלבד - אין עדיין דרישות תואר אמיתיות.
 * מרכיב את tracks של הפקולטה הזו מתוך window.FINDEG_TRACK_DEFS['biomedical-eng'] - נבנה ע"י כל
 * אחד מקבצי faculties/biomedical-eng/tracks/<track>/requirements.js (נטענים לפני קובץ זה,
...
window.FINDEG_DATA = (function () {
  const tracks = (window.FINDEG_TRACK_DEFS && window.FINDEG_TRACK_DEFS['biomedical-eng']) || {};
  return {
    courseNames: {},
    coursePoints: {},
    equivGroups: [],
