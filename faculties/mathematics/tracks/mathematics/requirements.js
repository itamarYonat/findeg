/* FinDeg – standby: מסלול "מתמטיקה", הפקולטה למתמטיקה.
 ...
 * נרשם לתוך window.FINDEG_TRACK_DEFS['mathematics']['mathematics'] - נאסף
...
window.FINDEG_TRACK_DEFS['mathematics'] = window.FINDEG_TRACK_DEFS['mathematics'] || {};
window.FINDEG_TRACK_DEFS['mathematics']['mathematics'] = {
  name: "מתמטיקה",
