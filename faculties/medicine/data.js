/* FinDeg – הפקולטה לרפואה: standby, שלד בלבד - אין עדיין דרישות תואר אמיתיות.
 * מרכיב את tracks של הפקולטה הזו מתוך window.FINDEG_TRACK_DEFS['medicine'] - נבנה ע"י כל
 * אחד מקבצי faculties/medicine/tracks/<track>/requirements.js (נטענים לפני קובץ זה,
...
window.FINDEG_DATA = (function () {
  const tracks = (window.FINDEG_TRACK_DEFS && window.FINDEG_TRACK_DEFS['medicine']) || {};
  return {
    courseNames: {},
    coursePoints: {},
    equivGroups: [],
