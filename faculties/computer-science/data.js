/* FinDeg – הפקולטה למדעי המחשב: standby, שלד בלבד - אין עדיין דרישות תואר אמיתיות.
 * מרכיב את tracks של הפקולטה הזו מתוך window.FINDEG_TRACK_DEFS['computer-science'] - נבנה ע"י כל
 * אחד מקבצי faculties/computer-science/tracks/<track>/requirements.js (נטענים לפני קובץ זה,
...
window.FINDEG_DATA = (function () {
  const tracks = (window.FINDEG_TRACK_DEFS && window.FINDEG_TRACK_DEFS['computer-science']) || {};
  return {
    courseNames: {},
    coursePoints: {},
    equivGroups: [],
